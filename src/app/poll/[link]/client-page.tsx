          ...
          <CardContent className="space-y-7 p-4 sm:space-y-10 sm:p-10">
            ...
            >
              {moods.map((mood) => (
                ...
                >
                  <span className="text-4xl transition-transform duration-200 group-hover:scale-110 sm:text-6xl">
                    {mood.emoji}
                  </span>
            ...
            <form onSubmit={controller.handleSubmit} className="space-y-6">
              ...
              <Button
                ...
                disabled={!controller.selectedMood || controller.submitVote.isPending}
              >
